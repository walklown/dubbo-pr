...
public class OtlpMetricsReporter extends AbstractMetricsReporter {
    ...
    public OtlpMetricsReporter(final URL url, ApplicationModel applicationModel) {
        ...
        ConfigManager applicationConfigManger = applicationModel.getApplicationConfigManager();
        // TODO not support config
        List<OtlpMetricConfig> otlpMetricConfigs = applicationConfigManger.loadConfigsOfTypeFromProps(OtlpMetricConfig.class);
        OtlpMetricConfig otlpMetricConfig = otlpMetricConfigs.get(0);
